...
const Navbar = ({ theme, setTheme }) => {
  ...
  transition={{duration: 0.6, ease : 'easeOut'}}
        ...
        className="relative flex justify-between items-center px-4 sm:px-12 lg:px-24 py-4 top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70">

            <img
                src={theme === "dark" ? assets.nex_logo : assets.nex_dark_logo}
      ...
      max-sm:flex max-sm:flex-col max-sm:bg-primary max-sm:text-white 
      max-sm:pt-20 flex sm:items-center gap-5 transition-all duration-300 ease-in-out`}>
                ...
                <a onClick={() => setSidebarOpen(false)} href="#contact" className="sm:hover:border-b">
                    Contact Us
                </a>
            </div>
